...
scimgateway.on('exploreUsers', function (baseEntity, startIndex, count, callback) {
  ...
  connection.on('connect', function (err) {
    if (err) {
      ...
      let err = new Error(`Explore-Users connect: MSSQL client connect error: ${err.message}`)
      return callback(err)
    }
    ...
    let request = new Request(sqlQuery, function (err, rowCount, rows) {
      if (err) {
        connection.close()
        let err = new Error(`Explore-Users connect: MSSQL client request: ${sqlQuery} Error: ${err.message}`)
        return callback(err)
      }
      for (let row in rows) {
...
scimgateway.on('createUser', function (baseEntity, userObj, callback) {
  ...
  connection.on('connect', function (err) {
    if (err) {
      console.log(err.message)
      let err = new Error(`Create-Users connect: MSSQL client connect error: ${err.message}`)
      return callback(err)
    }
    ...
    let request = new Request(sqlQuery, function (err, rowCount, rows) {
      if (err) {
        connection.close()
        let err = new Error(`Create-Users: MSSQL client request: ${sqlQuery} Error: ${err.message}`)
        return callback(err)
      }
      connection.close()
      callback(null)
...
scimgateway.on('deleteUser', function (baseEntity, id, callback) {
  ...
  connection.on('connect', function (err) {
    if (err) {
      console.log(err.message)
      let err = new Error(`Delete-User connect: MSSQL client connect error: ${err.message}`)
      return callback(err)
    }
    ...
    let request = new Request(sqlQuery, function (err, rowCount, rows) {
      if (err) {
        connection.close()
        let err = new Error(`Delete-User: MSSQL client request: ${sqlQuery} Error: ${err.message}`)
        return callback(err)
      }
      connection.close()
      callback(null)
...
scimgateway.on('modifyUser', function (baseEntity, id, attrObj, callback) {
  ...
  connection.on('connect', function (err) {
    if (err) {
      console.log(err.message)
      let err = new Error(`Modify-Users connect: MSSQL client connect error: ${err.message}`)
      return callback(err)
    }
    ...
    let request = new Request(sqlQuery, function (err, rowCount, rows) {
      if (err) {
        connection.close()
        let err = new Error(`Modify-Users: MSSQL client request: ${sqlQuery} Error: ${err.message}`)
        return callback(err)
      }
      connection.close()
      callback(null)
