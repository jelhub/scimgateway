...
// Email        %UE% (Emails, type=Work)                emails.work.value               emails [type eq work] 
// Phone        %UP% (Phone Numbers, type=Work)         phoneNumbers.work.value         phoneNumbers [type eq work]
// Company      %UCOMP% (Entitlements, type=Company)    entitlements.company.value      entitlements [type eq company]
//
//=================================================================================
