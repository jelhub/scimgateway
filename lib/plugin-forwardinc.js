...
scimgateway.on('createUser', function (baseEntity, userObj, callback) {
    ...
    getServiceClient(baseEntity, action, function (err, serviceClient) {
        ...
        let userObjWorkEmail = scimgateway.getArrayObject(userObj, 'emails', 'work');
        let userObjWorkPhone = scimgateway.getArrayObject(userObj, 'phoneNumbers', 'work');
        let userObjCompanyEntitlement = scimgateway.getArrayObject(userObj, 'entitlements', 'company');
        ...
        var soapRequest = {
            "user": {
                ...
                "emailAddress": userObjWorkEmail.value || null,
                "phoneNumber": userObjWorkPhone.value || null,
                "company": userObjCompanyEntitlement.value || null
            }
        };
    ...
    this.emit('getUser', baseEntity, id, "userName,id,and,all,the,rest", function (err, userObj) {
        if (err) {
            ...
            getServiceClient(baseEntity, action, function (err, serviceClient) {
                ...
                if (email == undefined) email = userObjWorkEmail.value; // original
                ...
                if (phoneNumber == undefined) phoneNumber = userObjWorkPhone.value; // original
                ...
                if (company == undefined) company = userObjCompanyEntitlement.value; // original
